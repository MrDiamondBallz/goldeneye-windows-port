...
int main() {
    ...
    std::printf("next_runtime_blocker=texture image stream is classified but still unbacked; next layer is real asset decompression/memp bank modeling before RT64/custom rendering\n");
    return 0;
}
